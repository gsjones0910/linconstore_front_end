...
import { ArrowDropDown, RssFeed } from '@mui/icons-material';
...
import FilterHeader from "./  _component/FilterHeader";
...
const Brands: React.FC<IProducts> = ({
  ...
  useEffect(() => {
    const handleRouteChange = () => {
      Cookies.set("storeScrollPos", window.scrollY.toString(),{expires:3});
