...
// import { ChatRole, addCurrentChatMessage, addMessageToAdminChat, addMessageToSpecificBuyer } from "../../Store/chat";
...
import { IMessage, insertNewAdminMessage, updateAdminMessages, insertNewMessage } from "../../Store/Message";
...
const AdminChat: React.FC<AdminChatPropType> = ({ handleBroadCast, adminChat, isBroadCast }) => {
    ...
    const onJoiningRoom = async () => {
        // let adminChat;
        // if (typeof window !== 'undefined') {
        //     adminChat = JSON.parse(localStorage.getItem('currentAdminChat'));
        // }
