...
const Product: React.FC<IProducts> = ({ data, reviews }) => {
  ...
  const onFollowSuccess = (data) => {
    ...
    Cookies.set("usf", JSON.stringify(data.following), { expires: 3 });
  };
                ...
                <Box className="imageGalleryMax" position={"sticky"} sx={{
                  ...
                  <Box sx={{
                    ...
                    <CopyToClipboard text={window.location.href}>
                      <ShareIcon sx={{ color: "var(--primary)", fontSize: isSmall && 14 }} />
                    </CopyToClipboard>
                  </Box>
                  <ImageGallery
                  ...
                  >
                    ...
                    >
                      <Stack direction={"row"} spacing={1}>
                        <Typography fontSize={12}>{productQuantity}</Typography>
                    ...
                    <Stack spacing={2} sx={{ mb: 1 }}>
                      ...
                      {!isMobile && (
                        <>
                          {!owner.sellGlobal && (!userInfo?.country || owner?.country !== userInfo?.country) &&
                          ...
                          >
                            <Button
                              disabled={isLoading || storeId === owner._id || (!owner.sellGlobal && (!userInfo?.country || owner?.country !== userInfo?.country))}
        ...
        }
        {
          showReviews && (
            <Box bgcolor={"white"} mt={2}>
              ...
              <Box position={"absolute"} bottom={isMobile ? 70 : 10} left={"calc(50% - 49px)"}>
